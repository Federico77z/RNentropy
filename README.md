...
The `main` branch contains the 1.3.3 release. The exact CRAN 1.2.3
...
Install version 1.3.3 from GitHub:
...
as a raw p-value and defaults to 0.05. The selected table reports the
